...
if sys.platform == "win32":
	...
	if UI:
		...
		try:
			sg.one_line_progress_meter('Installing...', 0, count_stages, 'Install')
			namefile_update_data = wget.download("https://raw.githubusercontent.com/romanin-rf/FileCat/master/update_api.json")
		except:
			sg.one_line_progress_meter('Installing...', count_stages, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 1, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 2, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 3, count_stages, 'Install')
			os.chdir(Directory)
		except:
			sg.one_line_progress_meter('Installing...', count_stages, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 4, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 5, count_stages, 'Install')
		...
		try:
			sg.one_line_progress_meter('Installing...', 6, count_stages, 'Install')
		...
		try:
			...
			sg.one_line_progress_meter('Installing...', 7, count_stages, 'Install')
		except:
			sg.one_line_progress_meter('Installing...', count_stages, count_stages, 'Install')
			ctypes.windll.user32.MessageBoxW(0, "FileNotFoundError: The file failed validation", "Install FileCat", 16)
			raise FileNotFoundError("The file failed validation")
		...
		# Распаковка .zip
		try:
			sg.one_line_progress_meter('Installing...', 8, count_stages, 'Install')
